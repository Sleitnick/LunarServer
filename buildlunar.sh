...
gcc /src/lunarserver.c /src/lunar.c /src/statepool.c /src/stringbuilder.c /src/list.c /lib/luaserver.so /lib/json.so -o /bin/lunarserver -I/bin/lua/src -L/bin/lua/src -llua -ldl -lm
